...
public class TrieNode
{
	...
	public void addWord(String word) 
	{
		...
		for (int i = 0; i < limit; i++) 
		{
			...
			if (!isNotLetter(letter)) continue;
	...
	{	
		...
		if (t.isWord()) words.add(t.getWord());
	...
	/*
	 * When this method is called, the "this" Node is pointing to the last
	 * character of the prefix string.  From this Node, look at all its
	 * children nodes (array) for branches of other patterns that complete
	 * the word with the prefix and return a List of those words 
	 */
